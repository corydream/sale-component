...
@Component({
  selector: 'app-table-demo-custom-filter-panel',
  template: `
    <bgx-table #nzTable [nzData]="displayData">
      <thead class="ant-table-thead nz-disable-thead">
        <tr>
          <th  class="nz-disable-th">
            Name
          ...
          <th class="nz-disable-th" nzShowFilter [nzFilters]="filterAddressArray" (nzFilterChange)="filterAddressChange($event)">Address</th>
        </tr>
      </thead>
      <tbody>
...
export class BgxDemoTableCustomFilterPanelComponent {
  searchValue = '';
  filterAddressArray = [
