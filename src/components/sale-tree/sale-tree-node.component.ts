...
@Component({
  ...
  templateUrl        : './sale-tree-node.component.html',
...
export class SaleTreeNodeComponent implements OnInit, OnChanges {
  ...
  @Input()
  set nzTreeNode(value: SaleTreeNode) {
  ...
  set nzSearchValue(value: string) {
    ...
    if (value && (this.nzTreeNode.title.includes(value))) {
      // if (this.nzTreeNode.title.includes(value.toLocaleUpperCase())) {
      //   this.nzUpper = true;
      // } else {
      //   this.nzUpper = false;
      // }
  ...
  // Output
  @Output() clickNode: EventEmitter<SaleFormatEmitEvent> = new EventEmitter();
  @Output() dblClick: EventEmitter<SaleFormatEmitEvent> = new EventEmitter();
  @Output() contextMenu: EventEmitter<SaleFormatEmitEvent> = new EventEmitter();
  @Output() clickCheckBox: EventEmitter<SaleFormatEmitEvent> = new EventEmitter();
  @Output() clickExpand: EventEmitter<SaleFormatEmitEvent> = new EventEmitter();
  @Output() nzDragStart: EventEmitter<SaleFormatEmitEvent> = new EventEmitter();
  @Output() nzDragEnter: EventEmitter<SaleFormatEmitEvent> = new EventEmitter();
  @Output() nzDragOver: EventEmitter<SaleFormatEmitEvent> = new EventEmitter();
  @Output() nzDragLeave: EventEmitter<SaleFormatEmitEvent> = new EventEmitter();
  @Output() nzDrop: EventEmitter<SaleFormatEmitEvent> = new EventEmitter();
  @Output() nzDragEnd: EventEmitter<SaleFormatEmitEvent> = new EventEmitter();
  ...
  constructor(private nzTreeService: SaleTreeService, private ngZone: NgZone, private renderer: Renderer2, private elRef: ElementRef) {
